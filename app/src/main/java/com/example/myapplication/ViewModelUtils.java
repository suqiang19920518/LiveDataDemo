...
public class ViewModelUtils {
    ...
    /**
     * 获取全局唯一的ViewModel
     * 常用于跨页面修改数据（并且需要刷新显示），比如在某个页面对该ViewModel里的MutableLiveData进行了observe，
    ...
    public static <T extends ViewModel> T getPrivateViewModel(Fragment fragment, Class<T> viewModelClass){
        return getPrivateViewModel(fragment.getActivity(),viewModelClass,fragment.getActivity());
    }
}
